        ...
        foreach( $post_types as $post_type) 
            {
                ...
                if ($post_type == 'post')
                            add_submenu_page('edit.php', 'Menu Order', 'Menu Order', 'level_'.$options['level'], 'to-interface-'.$post_type, 'TOPluginInterface' );
                            else
                            add_submenu_page('edit.php?post_type='.$post_type, 'Menu Order', 'Menu Order', 'level_'.$options['level'], 'to-interface-'.$post_type, 'TOPluginInterface' );
            }
    }
