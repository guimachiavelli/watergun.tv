<?php get_header(); ?>
	<?php
		...
		<section id="reel">
			...
			<iframe src="http://player.vimeo.com/video/<?php echo $reel_video[0]; ?>?title=0&amp;byline=0&amp;portrait=0&amp;color=00b8ff" width="100%" height="530" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
			</figure>
